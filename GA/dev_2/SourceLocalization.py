import redis
import pickle
from FFunc_keras import get_prediction_cmd
...
class SourceLocalizer:
    ...
    def compute_all_layers_dist(self):
        cmd_1 = get_prediction_cmd(self.backend_1, self.db_flag, 0, 0, 0, 'all')
        cmd_2 = get_prediction_cmd(self.backend_2, self.db_flag, 0, 0, 0, 'all')
    ...
    def checkCrash_NaN(self, f_prime):
        ...
        cmd_1 = get_prediction_cmd(self.backend_1, self.db_flag, 0, 0, 0, 'errors_0')
        cmd_2 = get_prediction_cmd(self.backend_1, self.db_flag, 0, 0, 0, 'errors_0')
